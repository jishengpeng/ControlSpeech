...
import numpy as np
from modules.vocoder.hifigan.pqmf import PQMF
from modules.vocoder.hifigan.nsf_module import SourceModuleHnNSF
...
class HifiGanGenerator(torch.nn.Module):
    def __init__(self, h, c_out=1):
        ...
        for i, (u, k) in enumerate(zip(h['upsample_rates'], h['upsample_kernel_sizes'])):
            ...
            #     ConvTranspose1d(c_cur * 2, c_cur, k, u, padding=(u//2 + u%2), output_padding=u%2)))
            self.ups.append(weight_norm(
        ...
        # self.pqmf = PQMF()
        # self.pqmf_out = None
        # self.pqmf_out = weight_norm(Conv1d(1, 1, 7, 1, padding=3))
        # self.pqmf_out.apply(init_weights)
    ...
    def forward(self, x, f0=None):
        ...
        for i in range(self.num_upsamples):
            ...
            # print(x.shape,x_source.shape,'*'*50)
            x = x + x_source
            xs = None
