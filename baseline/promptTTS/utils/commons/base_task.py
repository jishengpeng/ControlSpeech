...
class BaseTask(nn.Module):
    ...
    def on_train_start(self):
        ...
        #     if(k.startswith('fs_ada4.mel_style_encoder') or k.startswith('fs_ada4.mel_style_in')):
        #         v.requires_grad=False    
        #     if(k.startswith('fs_ada4.encoder') or k.startswith('fs_ada4.bsemb')):
        #         v.requires_grad=False
        #     if(k.startswith('fs_ada4.cross_attention')):
        #         v.requires_grad=False
        
        # for k,v in self.model.named_parameters():
        #     if k.startswith('ei_encoder.mlp'):
        #         v.requires_grad=False    
        #     if k.startswith('emo_decoder'):
        #         v.requires_grad=False
