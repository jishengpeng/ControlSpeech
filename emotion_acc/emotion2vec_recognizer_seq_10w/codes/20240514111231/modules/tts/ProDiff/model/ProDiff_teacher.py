...
class GaussianDiffusion(nn.Module):
    def __init__(self, phone_encoder, out_dims, denoise_fn,
        ...
        self.fs = FastSpeech(len(phone_encoder), hparams, out_dims)
    ...
    def forward(self, txt_tokens, mel2ph=None, spk_embed=None, spk_id=None,
                ref_mels=None, f0=None, uv=None, emotion=None, infer=False):
        b, *_, device = *txt_tokens.shape, txt_tokens.device
        ret = self.fs(txt_tokens, mel2ph, spk_embed, spk_id, f0, uv, emotion,
